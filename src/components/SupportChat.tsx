  ...
  return createPortal(
    ...
    >
      ...
      <div style={{ background: t.headerBg, borderBottom: `1px solid ${t.headerBorder}`, flexShrink: 0, paddingTop: '48px', backdropFilter: 'blur(12px)' }} className="flex items-center gap-3 px-4 pb-3">
        ...
        <button onClick={() => window.open('https://t.me/fynex_assist', '_blank')} className="flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center active:scale-95" style={{ backgroundColor: t.tgBg }}>
